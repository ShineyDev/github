...
if TYPE_CHECKING:
    ...
    from github.connection import Connection, DiscussionOrder, IssueOrder, LabelOrder, LanguageOrder, MilestoneOrder, PullOrder, ReferenceOrder, ReleaseOrder, RepositoryOrder
...
class Repository(
    ...
    def fetch_languages(
        ...
        **kwargs,  # TODO
        ...
        Fetches languages in the repository.
