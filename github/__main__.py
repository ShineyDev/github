...
def show_version():
    ...
    entries.append("- github.py v{0.major}.{0.minor}.{0.micro}-{0.releaselevel}".format(github.version_info))
    ...
    entries.append("")
    entries.append("- system info: {0.system} {0.version}".format(platform.uname()))
