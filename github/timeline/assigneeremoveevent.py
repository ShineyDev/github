...
class AssigneeRemoveEvent(Node, TimelineItem, Type):
    ...
    async def fetch_subject(
        ...
        **kwargs,  # TODO
        ...
        data = await self._http.fetch_assigneeremoveevent_subject(self.id, **kwargs)
        ...
        if data["__typename"] == "Issue":
            ...
            raise RuntimeError(f"unsupported type {data['__typename']} for UnassignedEvent.assignable")
