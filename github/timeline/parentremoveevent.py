...
if TYPE_CHECKING:
    ...
    class ParentRemoveEventData(NodeData, TimelineItemData, TypeData):
        __typename: Literal["ParentIssueRemovedEvent"]

        parent: IssueData | None


class ParentRemoveEvent(Node, TimelineItem, Type):
    """
    Represents a parent removed event on an :class:`~github.Issue`
    timeline.
