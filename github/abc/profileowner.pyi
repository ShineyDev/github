...
class ProfileOwner():
    ...
    @property
    def has_showcase_items(self) -> bool: ...
    @property
    ...
    def fetch_pinnable_items(self, *, types: List[PinnableItemType]=..., **kwargs) -> CollectionIterator[Union[Gist, Repository]]: ...
    def fetch_pinned_items(self, *, types: List[PinnableItemType]=..., **kwargs) -> CollectionIterator[Union[Gist, Repository]]: ...
